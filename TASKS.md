...
### [x] T-149: Убрать личные и корпоративные данные из документации

- Приоритет: Must.
- Зависимости: T-123.
- Описание: Найти и заменить личные имена, реальные email, внутренние домены
  и корпоративные URL в документации и project metadata на нейтральные
  примеры.
- Acceptance criteria:
  - В docs и корневой документации нет реальных email, имён, доменов или URL,
    не относящихся к публичным upstream dependencies.
  - Примеры используют reserved/example domains или generic maintainer data.
