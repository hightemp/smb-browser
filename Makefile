...
native-test: native-configure
	cmake --build $(NATIVE_BUILD_DIR) \
		--target test_native_smb_scaffold test_native_smb_protocol test_native_smb_dcerpc test_native_smb_dfs_referral test_native_smb_srvs_rpc test_native_smb_direct_tcp_transport test_native_smb_ntlm_messages test_native_smb_ntlm_crypto test_native_smb_spnego_token test_native_smb_signing test_native_smb_encryption test_native_smb_ntlm_v2_token_provider test_native_smb_connector test_native_smb_negotiator test_native_smb_session_setup test_native_smb_tree_connector test_native_smb_close_exchanger test_native_smb_change_notify_exchanger test_native_smb_read_exchanger test_native_smb_write_exchanger test_native_smb_set_info_exchanger test_native_smb_query_info_exchanger test_native_smb_directory_lister test_native_smb_directory_watcher test_native_smb_file_reader test_native_smb_file_writer test_native_smb_remote_object_operator test_native_smb_remote_stat_reader test_native_smb_remote_metadata_operator test_native_smb_remote_dfs_referral_fetcher test_native_smb_remote_share_enumerator test_native_smb_session test_native_smb_error_mapper test_native_dfs_referral_resolver $(JOBS)
